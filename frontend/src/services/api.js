// ------------------------------------------------------------------
// API helper for the Spring Boot backend.
//
// Local development:
//   Vite proxies /api -> http://localhost:8080
//
// Production:
//   The browser calls the deployed Render backend directly.
// ------------------------------------------------------------------
...
export const getRouteOrders = (routeId) =>
  request(`/api/routes/${routeId}/orders`)
...
export const assignOrderToRoute = (routeId, orderId) =>
  request(`/api/routes/${routeId}/orders/${orderId}`, {
    method: 'POST',
  })
...
export const assignTruck = (routeId, truckId) =>
  request(
    `/api/routes/${routeId}/truck?truckId=${encodeURIComponent(truckId)}`,
    {
      method: 'PUT',
    }
  )
...
export const unassignTruck = (routeId) =>
  request(`/api/routes/${routeId}/truck`, {
    method: 'DELETE',
  })

export const assignDriver = (routeId, driverId) =>
  request(
    `/api/routes/${routeId}/driver?driverId=${encodeURIComponent(driverId)}`,
    {
      method: 'PUT',
    }
  )
...
export const unassignDriver = (routeId) =>
  request(`/api/routes/${routeId}/driver`, {
    method: 'DELETE',
  })

export const dispatchRoute = (routeId) =>
  request(`/api/routes/${routeId}/dispatch`, {
    method: 'POST',
  })
